...
import type { ColumnFilterValue } from "./data";
...
export function DataTableFacetedFilter<TData, TValue>({
  ...
  return (
    <Popover open={open} onOpenChange={setOpen}>
      ...
      <PopoverContent className="w-[200px] p-0 lg:w-[280px]" align="start">
        <Command>
                ...
                .map((option) => {
                  ...
                  return (
                    ...
                    >
                      <div
                        className={cn(
                          "mr-2 flex size-4 items-center justify-center rounded-sm border border-primary lg:mr-3",
                          isSelected
